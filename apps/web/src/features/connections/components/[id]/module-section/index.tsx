...
import { ModuleSectionRoot } from './module-section.root'
import { ModuleSectionSubtitle } from './module-section.subtitle'
import { ModuleSectionTitle } from './module-section.title'

export const ModuleSection = {
  Root: ModuleSectionRoot,
